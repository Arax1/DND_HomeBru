...
class RaceListView(ListView):
    model = Race
    template_name = "character_builder/race_list.html"
...
class RaceDetailView(DetailView):
    ...
    template_name = 'character_builder/race_detail.html'
...
class RaceCreateView(LoginRequiredMixin, CreateView):
    model = Race
    template_name = "character_builder/race_create_form.html"
...
class RaceUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    model = Race
    template_name = 'character_builder/race_update_form.html'
    fields = ['name', 'description', 'age', 'alignment', 'size', 'speed', 'traits' ]
...
class RaceDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    model = Race
    template_name = 'character_builder/race_delete_form.html'
...
class ClassDetailView(DetailView):
    ...
    template_name = 'character_builder/class_detail.html'


class ClassCreateView(LoginRequiredMixin, CreateView):
    model = Class
    template_name = "character_builder/class_create_form.html"
...
class ClassUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    model = Class
    template_name = 'character_builder/class_update_form.html'
    fields = ['name', 'description', 'hit_dice']
...
class ClassDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    model = Class
    template_name = 'character_builder/class_delete_form.html'
...
class BackgroundListView(ListView):
    model = Background
    template_name = "character_builder/background_list.html"
...
class BackgroundDetailView(DetailView):
    ...
    template_name = 'character_builder/background_detail.html'


class BackgroundCreateView(LoginRequiredMixin, CreateView):
    model = Background
    template_name = "character_builder/background_create_form.html"
...
class BackgroundUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    model = Background
    template_name = 'character_builder/background_update_form.html'
    fields = ['name', 'description']
...
class BackgroundDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    model = Background
    template_name = 'character_builder/background_delete_form.html'
...
class CharacterListView(ListView):
    model = Character
    template_name = "character_builder/character_list.html"
    context_object_name = 'characters'


class CharacterDetailView(DetailView):
    model = Character
    template_name = 'character_builder/character_detail.html'
    context_object_name = "character_details"


class CharacterCreateView(LoginRequiredMixin, CreateView):
    model = Character
    template_name = "character_builder/character_create_form.html"
...
class CharacterUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    model = Character
    template_name = 'character_builder/character_update_form.html'
    fields = ['name', 'strength', 'intelligence', 'wisdom',
              'constitution', 'dextirity', 'charisma', 'race_key', 'class_key']
...
class CharacterDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    model = Character
    template_name = 'character_builder/character_delete_form.html'
...
class TraitCreateView(CreateView):
    model = Trait
    template_name = 'character_builder/trait_create_form.html'
    fields = ['name','description']
